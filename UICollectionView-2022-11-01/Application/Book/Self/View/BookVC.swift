...
class BookVC: UIViewController {
    ...
    func setUpSecurity() {
        NotificationCenter.default.addObserver(self, selector: #selector(showBlurScreen), name: NSNotification.Name("SHOW_BLUR"), object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(removeBlurScreen), name: NSNotification.Name("REMOVE_BLUR"), object: nil)
    ...
    @objc func showBlurScreen() {
        print("Show blur screen")
        // you can present your unique screen
    ...
    @objc func removeBlurScreen() {
        print("Remove blur screen")
